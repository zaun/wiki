...
const argv = yargs(hideBin(process.argv))
    ...
    .option('dir', { describe: 'Directory containing one or more .json node files', type: 'string' })
    .option('file', { describe: 'Single .json file to process', type: 'string' })
    .option('exclude', {
        describe: 'Filename to exclude when --dir is used (e.g., "excluded_node.json")',
        type: 'string',
...
async function uploadNode(page) {

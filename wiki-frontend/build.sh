...
# Commands: build-website | build-images | push-images | create-manifests | push-dev | help
...
Commands:
  build-website      Build only the Vue static site
  ...
  push-dev           Full cycle: build-site, build-images, push-images, create-manifests
